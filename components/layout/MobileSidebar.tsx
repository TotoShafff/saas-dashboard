  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      <div
        ...
        aria-hidden="true"
      />
      <div className="absolute inset-y-0 left-0 flex w-72 flex-col bg-white shadow-xl dark:bg-gray-950">
        ...
        <div className="border-t border-gray-200 px-4 py-4 dark:border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-medium text-gray-900 dark:text-white">Jane Doe</p>
              <p className="truncate text-xs text-gray-500 dark:text-gray-400">jane@company.com</p>
            </div>
          </div>
        </div>
      </div>
